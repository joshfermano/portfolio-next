    ...
    <motion.div
      ...
      <div className="flex flex-col space-y-2 md:space-y-3 text-center md:text-left flex-1">
        <motion.div
          ...
          transition={{ duration: prefersReducedMotion ? 0.1 : 0.3, delay: prefersReducedMotion ? 0 : 0.2 }}>
        ...
        <motion.div
          ...
          transition={{ duration: prefersReducedMotion ? 0.1 : 0.3, delay: prefersReducedMotion ? 0 : 0.3 }}
